...
if platform.system() == "Windows":
    ...
    screen_size = pygame.display.Info()
    win_width = screen_size.current_w
    win_height = screen_size.current_h - 58
    win = pygame.display.set_mode((win_width,win_height))
#win_width = 1100
#win_height = 600
#surface = pygame.display.get_surface()
#win_height, win_width = surface.get_height(), surface.get_width()
...
def show_connect_to_game(options, znacznik):
    ...
    win.blit(font.render(options[0],1,s.black), (int(0.11*win_width), int(0.8*win_height)))
    win.blit(font.render(options[1],1,s.black), (int(0.6*win_width), int(0.8*win_height)))
    if znacznik == 0:
        win.blit(font.render(options[0],1,s.zielony), (int(0.11*win_width), int(0.8*win_height)))
    elif znacznik == 1:
        win.blit(font.render(options[1],1,s.zielony), (int(0.6*win_width), int(0.8*win_height)))
    pygame.display.update()
